...
\definecolor{snublue}{RGB}{4, 44, 132}  
...
% --- 로고 파일 경로 분리 ---
\newcommand{\logofileLight}{figures/snu_logo.jpg}        % 평소(밝은 배경)용
\newcommand{\logofileDark}{figures/snu_logo_white.jpg}    % standout(어두운 배경)용
\newcommand{\logofile}{\logofileLight}                   % 기본값: 라이트
...
% --- standout 환경: 다크 로고 사용하도록 변경 ---
\newenvironment{standout}[2][]{%
  \begingroup
  % 이 프레임에서는 다크 로고를 사용하고, 로고 표시를 켬
